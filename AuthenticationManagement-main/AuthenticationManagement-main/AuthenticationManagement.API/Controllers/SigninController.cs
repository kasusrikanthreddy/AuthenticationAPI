...
namespace AuthenticationManagement.API.Controllers
{
    ...
    public class SigninController : ControllerBase
    {
        ...
        public async Task<IActionResult> Signin(LoginDTO dto)
        {
            ...
            string executiveEducation = string.Empty;
            string executiveExperience = string.Empty;
            string executiveSpecializationInDepartment = string.Empty;
           if (role == "Executive")
            {
                var executivedetails = context.Executives.First(i => i.AppUser.Id == user.Id);
                
                executiveExperience = executivedetails.Experience;
